...
import ru.maizy.cheesecake.checker.{ CheckResult, CheckStatus, HttpCheckResult }
import ru.maizy.cheesecake.resultsstorage.{ ClearEndpointCheckResults, AddEndpointCheckResults, AggregateType }
import ru.maizy.cheesecake.resultsstorage.{ SimpleAggregate, EndpointCheckResults, GetEndpointCheckResults}
import ru.maizy.cheesecake.resultsstorage.{ AggregatedResults, GetAggregatedResults, AllEndpoints }
import ru.maizy.cheesecake.resultsstorage.{ GetAllEndpoints, InMemoryResultStorageActor }
